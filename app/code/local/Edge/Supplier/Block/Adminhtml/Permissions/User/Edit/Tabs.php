 ...
 */
class Edge_Supplier_Block_Adminhtml_Permissions_User_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $roleId = implode('', Mage::getModel('admin/user')->load($this->getRequest()->getParam('user_id'))->getRoles());
