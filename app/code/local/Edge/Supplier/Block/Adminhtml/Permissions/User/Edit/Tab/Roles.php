...
class Edge_Supplier_Block_Adminhtml_Permissions_User_Edit_Tab_Roles extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->addFieldToFilter('role_name', array('neq' => 'Supplier'));
