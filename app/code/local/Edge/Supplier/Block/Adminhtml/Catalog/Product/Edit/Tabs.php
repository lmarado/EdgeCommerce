 ...
 */
class Edge_Supplier_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($setId) {
            ...
            if ($this->getProduct()->getAttributeText('product_supplier') === 'Admin') {
                $this->addTab('supplier', array(
                    'label'     => Mage::helper('catalog')->__('Supplier Products'),
                    'url'       => $this->getUrl('*/*/seller', array('_current' => true)),
                    'class'     => 'ajax',
                ));
            }
