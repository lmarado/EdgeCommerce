 ...
 */
class Edge_Supplier_Block_Adminhtml_Catalog_Product_Edit_Tab_Crosssell extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('catalog/product_link')->useCrossSellLinks()
                ...
                ->addAttributeToFilter('product_supplier',  $productSupplierOption[key($productSupplierOption)]['value']);
...
//                array('product' => Mage::getResourceModel('catalog/product')->getTable('catalog/product')),
//                'product.entity_id = e.entity_id',
//                array());
        
        Mage::log($collection->getSelect()->__toString(), null, 'edge.log');
//        $productSupplierOption = array_filter(
//                Mage::getModel('eav/config')->getAttribute('catalog_product', 'product_supplier')->getSource()->getAllOptions(), function($el) {
//            return ($el['label'] != 'Admin');
//        });
//        $collection->addAttributeToFilter('product_supplier', $productSupplierOption[key($productSupplierOption)]['value']);
