 ...
 */
class Edge_Supplier_Model_Catalog_Product_Link extends Mage_Catalog_Model_Product_Link
{
    const LINK_TYPE_SUPPLIER      = 6;
    
    /**
     * @return Mage_Catalog_Model_Product_Link
     */
    public function useSellerLinks()
    {
        $this->setLinkTypeId(self::LINK_TYPE_SUPPLIER);
        return $this;
    }
    ...
    public function saveProductRelations($product)
    {
        ...
        $data = $product->getSellerLinkData();
        if (!is_null($data)) {
            $this->_getResource()->saveProductLinks($product, $data, self::LINK_TYPE_SUPPLIER);
        }
