 ...
 */
class Edge_Reports_Model_Resource_Report_Topsuppliers extends Edge_Reports_Model_Resource_Report_Abstract
{
    ...
    {
        $this->_init('edge_reports/topsuppliers_aggregated_' . self::AGGREGATION_DAILY, 'id');
    }
     ...
     * @param mixed $from
     * @param mixed $to
     * @return Mage_Sales_Model_Resource_Report_Bestsuppliers
     */
    public function aggregate($from = null, $to = null)
    {
        ...
        try {
            ...
            $columns = array(
                ...
                'social_designation'     => new Zend_Db_Expr(
                    sprintf('MIN(%s)',
                        $adapter->getIfNullSql('supplier.social_designation','supplier.supplier_id')
                    )
                ),
            ...
            $select->joinInner(
                array('supplier' => $this->getTable('edge_supplier/supplier')),
                'supplier.supplier_id = order_item.supplier_id',
                array()
            );
            ...
            $columns = array(
                ...
                'social_designation'             => new Zend_Db_Expr('MIN(social_designation)'),
            ...
            $this->_setFlagData(Edge_Reports_Model_Flag::REPORT_TOPSELLERS_FLAG_CODE);
        } catch (Exception $e) {
    ...
    {
        $aggregationTable   = $this->getTable('edge_supplier/topsuppliers_aggregated_' . $aggregation);
        ...
        Mage::getResourceHelper('edge_reports')
            ->getTopsuppliersReportUpdateRatingPos($aggregation, $aggregationAliases,
